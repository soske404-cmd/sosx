...
from response_autostripe import format_autostripe_response
...
async def handle_au(client, message):
    """
    Single card checker for Autostripe
    Command: /au cc|mm|yy|cvv or .au cc|mm|yy|cvv
    """
    try:
...
<code>Reduce Antispam Time /buy Using Paid Plan</code>""",
        ...
        # Call Autostripe API
        result = await check_card_autostripe(user_id, fullcc, site)
