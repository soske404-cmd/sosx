...
# async def add_site_handler(client, message: Message):
...
#         end_time = time.time()
#         time_taken = round(end_time - start_time, 2)
#         return await wait_msg.edit_text(f"⚠️ Error: `{str(e)}`\n⏱️ Time Taken: `{time_taken} sec`", parse_mode=ParseMode.MARKDOWN)
